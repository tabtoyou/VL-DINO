...
class BertForPreTraining(BertPreTrainedModel):
    ...
    def forward(
        ...
        '''
        add_cls = np.repeat(output.last_hidden_state[:,0,:],len(output[0,:,0]))
        print(add_cls.size())
        sequence_output += add_cls
        '''
...
class BertForMaskedLM(BertPreTrainedModel):
    ...
    def forward(
        ...
        cls_repeat = cls_output.repeat(len(sequence_output[0,:,0]),1,1).permute(1,0,2)
        
        sequence_output += cls_repeat
        '''
        prediction_scores = self.cls(sequence_output)
